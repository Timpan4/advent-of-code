...
// When typing bun run latest it will run this file

// Get todays date
const today = new Date();
// Extract the year and the month and the day
const year = today.getFullYear();
const month = today.getMonth() + 1; // January is 0 so we add 1 to get the correct month
